...
export const metadata: Metadata = {
  ...
  icons: {
  icon: [
    { url: '/newlogo2.jpg', sizes: '16x16', type: 'image/png' },
    { url: '/newlogo2.jpg', sizes: '32x32', type: 'image/png' },
    { url: '/newlogo2.jpg', sizes: '16x16 32x32 48x48', type: 'image/x-icon' },
    { url: '/newlogo2.jpg', sizes: '192x192', type: 'image/png' },
    { url: '/newlogo2.jpg', sizes: '512x512', type: 'image/png' }
  ],
