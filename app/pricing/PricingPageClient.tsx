...
export default function PricingPageClient({ initialCategories }: { initialCategories: PricingCategory[] }) {
  const [categories] = useState<PricingCategory[]>(initialCategories);
