...
import type { ServerBlogPost } from '@/lib/blog-server';

interface BlogPageClientProps {
  initialPosts: ServerBlogPost[];
}

export default function BlogPageClient({ initialPosts }: BlogPageClientProps) {
  const [posts] = useState<ServerBlogPost[]>(initialPosts);
  const [filteredPosts, setFilteredPosts] = useState<ServerBlogPost[]>(initialPosts);
