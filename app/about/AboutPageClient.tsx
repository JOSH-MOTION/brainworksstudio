      ...
      <section className="py-12 bg-gradient-to-br from-teal-50 to-teal-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-gray-600 max-w-4xl mx-auto text-center mt-8"
          >
            Within Accra, we regularly shoot in East Legon, Cantonments, Airport Residential
            Area, Osu, Labone, Dzorwulu, Roman Ridge, Ridge, Kaneshie, Dansoman, Achimota,
            Madina, Adenta, Spintex, Tema, Teshie, Nungua, Labadi, and Kasoa — and we travel
            further for destination work in Kumasi, Takoradi, Cape Coast, Tamale, and across
            Ghana, West Africa, and the diaspora.
          </motion.p>
        </div>
      </section>
