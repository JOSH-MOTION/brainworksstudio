    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-orange-50">
        <div className="max-w-2xl w-full text-center">
          ...
          {showDebugInfo && (
            <Card className="mt-6 text-left bg-white border-gray-200">
              <CardHeader>
                <CardTitle className="text-lg text-gray-900">Debug Information</CardTitle>
              </CardHeader>
              <CardContent className="space-y-2 text-sm text-gray-600">
                ...
                <div><strong>Firebase User:</strong> {firebaseUser ? 'Available' : 'None'}</div>
                {debugInfo && (
    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-2">Manage and review all client photography session requests</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Badge className="bg-orange-100 text-orange-800 px-3 py-1">Total: {bookings.length}</Badge>
      ...
      {bookings.length === 0 ? (
        <Card className="bg-white border-gray-200">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-400 text-sm">Client booking requests will appear here</p>
            <Button
              onClick={fetchBookings}
              variant="outline"
              ...
              <Card className="hover:shadow-lg transition-shadow bg-white border-gray-200">
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className={`px-3 py-1 text-sm ${getStatusBadgeColor(booking.status)}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">{booking.userInfo?.displayName || 'Unknown Client'}</p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm text-gray-600">{getLocationText(booking.location)}</p>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                  ...
                  {booking.additionalNotes && (
                    <div className="border-t border-gray-200 pt-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-sm text-gray-900">Client Notes:</p>
                  ...
                  {booking.adminNotes && (
                    <div className="border-t border-gray-200 pt-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-sm text-orange-600">Admin Notes:</p>
                        ...
                        {showDeclineForm[booking.id] && (
                          <div className="border rounded-lg p-4 bg-red-50">
                            ...
                            <Textarea
                              ...
                              rows={3}
                              className="mb-3 border-gray-300 focus:ring-orange-600 text-sm"
